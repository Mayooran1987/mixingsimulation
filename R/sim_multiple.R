...
##' n_sim <- 20000
##' round(colMeans(sim_multiple(mu, sigma, alpha, k, distribution, n_sim)))
##' # A further example can be found on the following page <https://rpubs.com/mayooran/sim_multiple>.
##' @export
