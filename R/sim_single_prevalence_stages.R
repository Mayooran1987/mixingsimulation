##' This function provides an estimated prevalence value at each stage of the mixing process of the single mixing scheme.
##' @title The estimated prevalence value at each stage of the mixing process of the single mixing scheme.
...
##' @return the estimated prevalence at each stage of the mixing process.
...
##' This function provides an estimated prevalence in each stage of the mixing process. To more details, please refer the details section of  \link{compare_mixing_prevalence}.
...
##' UL <- 138
##' n_sim <- 20000
##' sim_single_prevalence_stages(mu, sigma , alpha_in, k, l, rate, distribution, UL, n_sim)
##' @export
sim_single_prevalence_stages <- function(mu, sigma , alpha_in, k, l, rate, distribution, UL, n_sim){
